...
public class VuforiaManager implements Runnable {
    ...
    private static final String VUFORIA_KEY =
            "";
    ...
    public void run() {
        while (!linearOpMode.isStopRequested() && this.shouldScan) {
            ...
            if (targetVisible) {
                ...
                linearOpMode.telemetry.addData("Visible Target", "none");
            }
